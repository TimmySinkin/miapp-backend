...
public class ClaudeController {
    ...
    private static final String CHAT_SYSTEM_PROMPT =
        ...
        "таблицу, задай РОВНО ОДИН уточняющий вопрос в формате <<<CLARIFY>>>: \"Когда вы готовы " +
        "начать?\" с вариантами [\"Сегодня\", \"Завтра\"]. Только после ответа на этот вопрос (или после " +
        "«Пропустить», что означает «сегодня» по умолчанию) показывай таблицу плана, считая днём 1 " +
        "выбранную дату старта. Если пользователь уже ответил на этот вопрос ранее в этом чате — " +
        "не спрашивай снова, сразу используй уже данный ответ.\n" +
